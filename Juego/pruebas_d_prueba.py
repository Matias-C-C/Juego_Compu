...
def multijugador():
    ...
    while corriendo:
        ...
        dibujar_texto(f"Puntos Jugador 1: {puntos_jugador1}", FUENTE_BOTON, BLANCO, 100, 30)
...
def modo():
    ...
    while ejecutando_modo:
        ...
        boton_multi = dibujar_texto("MULTIJUGADOR", FUENTE_BOTON, color_multi, ANCHO //  2.05, ALTO // 2.5 + 80)
