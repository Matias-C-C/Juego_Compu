...
avatar_seleccionado = ruta_avatar[0]  # valor por defecto
#endregion
...
def avatar():
    global avatar_seleccionado  # así lo podemos usar fuera de esta función
    corriendo = True
            ...
            if evento.type == pygame.QUIT:
                ...
                for i, rect in enumerate(rects_avatar):
                    if rect.collidepoint(evento.pos):
                        ...
                        corriendo = False  # salir de la selección

        fondito = pygame.image.load(fondo_avatar)  # <- AQUÍ PODÉS CAMBIAR EL FONDO
...
def mostrar_puntajes():
    ...
    while ejecutando:
        ...
        for i, puntaje in enumerate(puntajes[-10:][::-1]):  # últimos 10
        ...
        if volver_btn.collidepoint(mouse_pos) and click[0]:
            pygame.time.wait(200)
            ejecutando = False  # volver al menú
...
def jugador_enemigo():
    ...
    while corriendo:
        ...
        # Disparo aleatorio enemigo cada 3 segundos
        ...
        # GANASTE RONDA - Generar nueva fila hasta 5
